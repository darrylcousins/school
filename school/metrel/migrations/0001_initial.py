# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-07-01 04:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activityid', models.ForeignKey(blank=True, db_column='ActivityId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.Activities')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applianceid', models.ForeignKey(db_column='ApplianceId', to='metrel.Appliances')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autotestgroupid', models.ForeignKey(blank=True, db_column='AutoTestGroupId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.AutoTestGroups')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_column='Name', max_length=20)),
                ('datalistgroupid', models.ForeignKey(db_column='DataListGroupId', on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.DataListGroups')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('applianceid', models.ForeignKey(db_column='ApplianceId', on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.Appliances')),
                ('autotestid', models.ForeignKey(blank=True, db_column='AutoTestId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.AutoTests')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('functionid', models.ForeignKey(db_column='FunctionId', on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.Functions')),
            ],
            options={
                'db_table': 'Limits',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archived', models.SmallIntegerField(blank=True, db_column='Archived', null=True)),
                ('parentid', models.ForeignKey(blank=True, db_column='ParentId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.Premises')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_column='Name', max_length=20)),
                ('archived', models.SmallIntegerField(blank=True, db_column='Archived', null=True)),
                ('customerid', models.ForeignKey(blank=True, db_column='CustomerId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='metrel_customer_projects_related', to='metrel.BusinessSubjects')),
                ('validatorid', models.ForeignKey(blank=True, db_column='ValidatorId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='metrel_validator_projects_related', to='metrel.BusinessSubjects')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('limitid', models.ForeignKey(db_column='LimitId', on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.Limits')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='premises',
            name='projectid',
            field=models.ForeignKey(db_column='ProjectId', on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.Projects'),
        ),
        migrations.AddField(
            model_name='functions',
            name='functiontypeid',
            field=models.ForeignKey(db_column='FunctionTypeId', on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.FunctionTypes'),
        ),
        migrations.AddField(
            model_name='datalistgroups',
            name='datalisttypeid',
            field=models.ForeignKey(db_column='DataListTypeId', on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.DataListTypes'),
        ),
        migrations.AddField(
            model_name='checkbox',
            name='datalistitemid',
            field=models.ForeignKey(db_column='DataListItemId', on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.DataListItems'),
        ),
        migrations.AddField(
            model_name='appliances',
            name='patid',
            field=models.ForeignKey(blank=True, db_column='PATId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.Pats'),
        ),
        migrations.AddField(
            model_name='appliances',
            name='premisesid',
            field=models.ForeignKey(db_column='PremisesId', on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.Premises'),
        ),
        migrations.AddField(
            model_name='appliances',
            name='repaircodeid',
            field=models.ForeignKey(blank=True, db_column='RepairCodeId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.RepairCodes'),
        ),
        migrations.AddField(
            model_name='appliances',
            name='userid',
            field=models.ForeignKey(blank=True, db_column='UserId', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='metrel.Users'),
        ),
    ]

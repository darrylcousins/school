USE ellesmere;
DELETE FROM dbo.caretaking_location;
...
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(1, 'ABlock', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(2, 'ABlockCloister', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(3, 'ABlockCommon', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(4, 'ABlockEast', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(5, 'ABlockNorth', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(6, 'ABlockSouth', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(7, 'ABlockWest', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(8, 'Administration', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(9, 'Art', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(10, 'BBlock', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(11, 'BBlockCloister', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(12, 'BBlockCommon', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(13, 'BBlockEast', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(14, 'BBlockSouth', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(15, 'BBlockWest', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(16, 'Boiler', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(17, 'Busbay', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(18, 'Canteen', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(19, 'Careers', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(20, 'CaretakerShed', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(21, 'CBlock', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(22, 'CBlockCloister', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(23, 'CBlockFoyer', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(24, 'CollegeBoundary', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(25, 'Containers', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(26, 'Counsellor', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(27, 'Design', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(28, 'English', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(29, 'ESOL', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(30, 'Gym', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(31, 'GymChangingRoom', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(32, 'GymFoyer', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(33, 'GymGarage', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(34, 'GymOffice', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(35, 'Hall', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(36, 'HBlock', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(37, 'HBlockNorth', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(38, 'HBlockSouth', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(39, 'HBlockWest', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(40, 'HealthCentre', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(41, 'HomeEconomics', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(42, 'Hospitality', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(43, 'Hothouse', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(44, 'LabA', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(45, 'LabB', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(46, 'LabC', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(47, 'LabP', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(48, 'Library', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(49, 'Maintenance', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(50, 'Maori', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(51, 'Math', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(52, 'Metalshop', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(53, 'Music', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(54, 'MusicRehearsal', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(55, 'OBlock', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(56, 'PBlock', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(57, 'Room1', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(58, 'Room10', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(59, 'Room12', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(60, 'Room13', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(61, 'Room14', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(62, 'Room15', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(63, 'Room16', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(64, 'Room17', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(65, 'Room18', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(66, 'Room19', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(67, 'Room2', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(68, 'Room20', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(69, 'Room21', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(70, 'Room22', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(71, 'Room23', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(72, 'Room24', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(73, 'Room4', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(74, 'Room5', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(75, 'Room6', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(76, 'Room7', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(77, 'Room9', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(78, 'ScienceTech', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(79, 'SCR', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(80, 'ServerRoom', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(81, 'Stage', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(82, 'TechGarage', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(83, 'Textile', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(84, 'TractorShed', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(85, 'VanGarage', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(86, 'WilsonRoom', @placemark);
...
SET @validGeom = @geom.MakeValid().STUnion(@geom.STStartPoint());
SET @placemark = @validGeom;
INSERT INTO dbo.caretaking_location(locationid, name, polygon) VALUES(87, 'Woodshop', @placemark);
